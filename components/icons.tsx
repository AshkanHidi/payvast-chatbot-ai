...
export const VideoPlayIcon = (props: React.SVGProps<SVGSVGElement>) => (
...
export const DatabaseIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7a8 4 0 0116 0M12 3v4" />
  </svg>
);
...
// New Icons for KB Manager
export const ThumbsUpIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M14 10h4.764a2 2 0 011.789 2.894l-3.5 7A2 2 0 0115.263 21h-4.017c-.163 0-.326-.02-.485-.06L7 20m7-10V5a2 2 0 00-2-2h-.085a2 2 0 00-1.736.97l-2.714 4.256A2 2 0 015.343 10H5a2 2 0 00-2 2v6a2 2 0 002 2h2.172a2 2 0 001.732-1.03l.368-.621a1 1 0 011.732 0l.368.621a2 2 0 001.732 1.03H15a2 2 0 002-2v-6a2 2 0 00-2-2h-1.5" />
  </svg>
);

export const ThumbsDownIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10 14H5.236a2 2 0 01-1.789-2.894l3.5-7A2 2 0 018.738 3h4.017c.163 0 .326.02.485.06L17 4m-7 10v5a2 2 0 002 2h.085a2 2 0 001.736-.97l2.714-4.256A2 2 0 0118.657 14H19a2 2 0 002-2V6a2 2 0 00-2-2h-2.172a2 2 0 00-1.732 1.03l-.368.621a1 1 0 01-1.732 0l-.368-.621a2 2 0 00-1.732-1.03H9a2 2 0 00-2 2v6a2 2 0 002 2h1.5" />
  </svg>
);
